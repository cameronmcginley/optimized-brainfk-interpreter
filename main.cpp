...
int main(int argc, char** argv) {
    ...
    auto execution_duration = duration_cast<microseconds>(execution_end - execution_start);

    std::cout << "\nPreprocess time: " << preprocess_duration.count() << " microseconds\n"
        << "Execution time: " << execution_duration.count() << " microseconds\n"
        << "Total time: " << preprocess_duration.count() + execution_duration.count() << " microseconds\n";
}
